    ...
    <>
     <section className='bg-Mischka h-[100vh]'>
        ...
        <motion.p style={{opacity:paragraph1Opacity,y:paragraph1TranslateY}} className='w-[50%] font-herofont pt-20'>
            <h1 className='text-[40px]'>Project 03</h1>
            <h1 className='text-[55px] font-semibold'>My Blog Web</h1>
        ...
        <motion.img style={{opacity , scale , x}}  className='w-[50%] my-auto' src={project3img} alt="" />
        </motion.div>
    </section>   
    </>
  )
