...
const BlogsContent = () => {
  ...
  return (
    <>
    <div className='h-[80vh] bg-Mischka'>
        <div className='w-[1000px] mx-auto p-10 flex gap-16'>
            <div className='w-[400px] h-[240px] shadow-2xl rounded-3xl p-5' >
                ...
                <div className='flex gap-5'>
                    ...
                    <div className='mt-2 flex items-center gap-1'>
                        ...
                        <h1 className='font-bold text-xl'>2007</h1>
                    </div>
                </div>
            ...
            <div className='w-[400px] h-[240px] shadow-2xl rounded-3xl p-5 z-30' >
